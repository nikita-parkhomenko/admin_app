...
// NOTE prepare original SweetAlert2 to react
const ReactSweetAlert = withReactContent(SweetAlert2);
...
export class Swall {
  ...
  static success (options) {
    return Swall.fire({ ...operationSuccess, ...options });
  }
  ...
  static error (options) {
    return Swall.fire({ ...operationError, ...options });
  }
  ...
  static confirm (options) {
    return Swall.fire({ ...confirmDelete, ...options });
  }
  ...
  static inputName (options) {
    return Swall.fire({ ...inputName, ...options });
  }
}
